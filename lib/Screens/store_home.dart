...
class StoreHome extends StatefulWidget {
  ...
  const StoreHome(this.businessID, {super.key});
...
class _StoreHomeState extends State<StoreHome> {
  ...
  Widget build(BuildContext context) {
    ...
    if (categoriesProvider.categoryList.isEmpty) {
      return Center(
        child: Container(
          height: 100,
          width: 100,
    ...
    if (businessProvider.businessSchedule.isEmpty) {
          ...
          slivers: [
            ...
            SliverToBoxAdapter(
              child: StreamProvider<List<Products>>.value(
                  initialData: const [],
                  value:
                      DatabaseService().featuredProductList(widget.businessID),
                  child: SizedBox(
                      height: 240,
                      width: double.infinity,
